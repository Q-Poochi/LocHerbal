...
// ⚠️ CHỈ dùng GET /hero-banner (1 object, KHÔNG PHẢI mảng)
// ⚠️ TUYỆT ĐỐI KHÔNG gọi GET /banners ở file này
...
import SupportModal from '@/components/storefront/SupportModal';
...
export default function HeroSection() {
    ...
    useEffect(() => {
        apiClient
            .get<HeroBannerData | null>('/hero-banner')
            .then((res) => setHero(res.data ?? null))
            .catch(() => setHero(null));
    }, []);
        ...
        <>
            ...
            >
                <div className="max-w-[1280px] mx-auto px-4 md:px-10 py-16 md:py-24 lg:py-28
                    ...
                    <div className="flex-1 text-center md:text-left animate-fade-in-up">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 justify-center md:justify-start">
                            ...
                            <button
                                ...
                                className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full
                                           border-2 border-accent-gold text-accent-gold font-semibold text-base
                                           hover:bg-accent-gold-pale hover:scale-[1.02]
                                           transition-all duration-200"
                            >
                    ...
                    {/* ── RIGHT: Visual — hero banner (1 ảnh) HOẶC fallback icon chày cối ── */}
