...
async function main() {
  ...
  // 1. Đảm bảo Role 'admin' và 'customer' tồn tại (upsert, không tạo trùng)
  ...
  // 3. Tạo user CUSTOMER test (KHÔNG gán role nào — đại diện customer thường)
...
async function cleanup() {
  const emails = ['rbac-admin-test@locherbal.local', 'rbac-customer-test@locherbal.local'];
